    ...
    <template v-if="user && user.crsid">
      <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12">
        <h1 class="mdc-typography--headline2">
          Upload a comment to the room database
        </h1>
        <p>Uploading as {{ this.user.crsid }}</p>
      </div>
      <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12">
        <p>
          Please write a useful comment, not just "it was nice". We would like
          to improve the availability of access-related information for our
          rooms. Please include descriptions of the relative noise levels,
          dampness and comfort of furniture in your comment. If you can think of
          any other features that relate to accessibility, please mention these
          too.
        </p>
        <div
          ref="text_area"
      ...
      <button
        class="mdc-button mdc-button--outlined mdc-layout-grid__cell mdc-layout-grid__cell--span-4"
        @click="submit()"
      >
        Submit
      </button>
