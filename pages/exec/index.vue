<template>
  <PostPage v-if="execs">
    ...
    <p class="mdc-typography--body1">The Exec members will be present at
      <nuxt-link to="/info/open_meetings">Open Meetings</nuxt-link>, where they will formally answer any questions you might have. However, if you've got a more informal or urgent question, don't hesitate to get in touch! You can find all the email addresses of each Exec member on their page, just use the menu at the top to find the member you need.
    </p>
